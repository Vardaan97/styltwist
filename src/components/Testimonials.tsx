    ...
    >
      ...
      {testimonials.map((t, i) => (
        ...
        >
          ...
          {/* Decorative quote mark — tinted per slide */}
          <span
          ...
          <div className="relative z-10 flex items-center gap-4 text-center">
            <div className="w-12 h-px" style={{ background: t.accent, opacity: 0.5 }} />
            <div>
              <p className="font-mono text-xs tracking-widest uppercase" style={{ color: t.accent }}>
                {t.name}
              </p>
